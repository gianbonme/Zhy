...
gargalo_atual: "Máquina HPP / Rotuladora / Garrafa"
responsavel: "Alvaro / Priscila"
---
# 🧃 Sucos Cold Press — "Ritual Clareza"

> Para momentos de reset, purificação e integração.

**Status Oficial**: 9 formulações prontas.
**Regulação**: MAPA (Cuidados na nomenclatura devido aos cogumelos — Priscila).
**Parceiro de produção**: Vida Líquida (Alvaro) no RJ.
**Canais alvo**: Shoppings, Supermercados chiques, Aeroportos, E-commerce (assinaturas e avulsos).
...
| Suco | Cogumelo | Foco |
|---|---|---|
| Cacau, Graviola e Cupuaçu | Tremella | Hidratação, indulgência saudável |
| Super Berry | Tremella | Antioxidante, beleza |
| Manga | Juba de Leão | Foco, energia |
| Açaí | Juba de Leão | Foco, vitalidade |
| Maracujá | Tremella | Calma, hidratação |
| Detox Verde | Juba de Leão | Limpeza, clareza |
