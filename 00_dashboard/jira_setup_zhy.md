...
| Nível | Exemplo |
|:------|:--------|
| Initiative | "Lançar Fase 1 até Ago/2026" |
...
|:-----|:-------------------|
| ☕ Linha Café (Cápsulas + Moído) | Fase 1 — Ago/2026 |
| 🧃 Sucos Cold Press | Fase 1 — Ago/2026 |
...
|:----------|:-------------------------|:-----|
| 🚀 Lançar Fase 1 | HPP fechado · PET definido · Site live · 100 unidades vendidas | Ago/01 |
