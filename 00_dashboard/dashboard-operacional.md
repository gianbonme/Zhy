...
## 🤝 Alianças Estratégicas e Parceiros
Relação nominal das parcerias e profissionais atuando na base:
- **Vida Líquida (Alvaro)**: Produção de sucos cold press (Rio de Janeiro).
- **MushSpresso (Adriel)**: Produção das cápsulas de café e pó moído (Brasília).
...
## 👥 Estrutura Organizacional da Zhy

Visão esquemática em formato de texto para rápida consulta e acompanhamento:
...
└────┬────┘             └────┬────┘              └────┬────┘
     │                       │                        │
     ├─ Vida Líquida         ├─ Marketing             ├─ Advogada MAPA
     │  (Alvaro - Sucos)     │  (Caco/Carol)          │  (Priscila)
     ├─ MushSpresso          ├─ Agência Rebu          │
     │  (Adriel - Café)      │  (Marca Definitiva)    └─ Advogada ANVISA
     ├─ Parceiro Solúveis    │                           (Adriana)
     │  (A Definir)          │
     └─ Parceiro RTD         │
        (A Definir)          │
```
...
## 🎯 Plano de Ação e Foco (O Campo de Batalha)

> Este é o espaço diário de execução. O "Norte Magnético", as prioridades da semana e a régua de 120 dias vivem aqui.

### 🧭 Foco Tático (Fase 1)
*A prioridade máxima agora, aquilo que traz oxigênio financeiro pra Zhy e decola a Fase 1 (Sucos e Cápsulas), resume-se em bater a nossa meta estruturada em 4 meses:*

- **O Horizonte:** 120 Dias (2 meses de Setup/Pré + 2 meses de Vendas).
- **A Meta:** 4.000 Unidades.
- **O Mix:** 3.000 Sucos HPP + 1.000 Caixas de Cápsulas (Atenção: cada caixa contém 10 cápsulas).

#### 🛡️ Os 2 Pilares do "Destrave"
1. **A Questão de Vida ou Morte (O HPP do Suco):** Mapear máquina HPP no Rio ativamente para garantir prateleira. Resolvido o HPP, adquire-se a rotuladora do Alvaro e a fábrica acende.
2. **O Check-Out Operacional (Cápsulas):** Validar o molde de Brasília perfeitamente e mandar rodar as 900 caixas restantes de forma segura.

---

### 🗓️ Motor de Execução (Checklist 16 Semanas)
...
- [ ] **Semana 5:** Compilar feedback dos testes de protótipos. Ajustar dosagens, rótulos ou pitch se necessário.
- [ ] **Semana 6:** Disparar produção do Lote 1 Oficial (Caixas de 10 Cápsulas + 3 SKUs de Suco).
- [ ] **Semana 7:** Contratação de vendedor B2B e formulação de uma "Lista de 100 Prospects" prioritários no RJ.
- [ ] **Semana 8:** Treinamento de vendas (Pitch agressivo da Zhy), alinhamento da logística final de distribuição.

#### BLOCO 3: VENDAS & PRIMEIRA TRAÇÃO (SEMANAS 9-12) | Mês 3
...
- [ ] **Semana 12:** Meta: 10 pontos B2B ativos. Identificar quais SKUs (sabores) já precisam de reposição.

#### BLOCO 4: ESCALA & CONSOLIDAÇÃO (SEMANAS 13-16) | Mês 4
...
- [ ] **Semana 14:** Meta: 15 pontos B2B. Focar incansavelmente na recompra (*rebuy*) baseando-se no que girou no Mês 3.
- [ ] **Semana 15:** Apertar CAC D2C e escalar as campanhas que mais converteram caixas de cápsulas.
- [ ] **Semana 16:** Meta: 20 pontos B2B ativos. Bater o marcador de 4.000 unidades (3k sucos + 1k caixas) e planejar a Fase 2.

---

### ⚙️ Rotina de Gestão (Checklist Fixo)
- **Diária:** 5-10 novos contatos/visitas B2B, acompanhamento e despacho de pedidos diários pelo site (D2C).
- **2ª Feira:** Revisão tática (Quais SKUs giraram mais na última semana? Quem pediu reposição no B2B?).
- **6ª Feira:** Revisão financeira e metas (O que quebrou? Onde falhamos na semana? Ajuste de rota pro fim de semana).

---

> [!TIP]
> **Referência rápida:** Para o plano tático detalhado de 30/60/90 dias com gargalos e deadlines específicos, consulte o [Plano de Lançamento Zhy](./plano-lancamento-zhy.md).
